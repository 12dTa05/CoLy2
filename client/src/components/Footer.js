        ...
        <Row className="align-items-center">
          <Col md={4} className="text-center text-md-start mb-3 mb-md-0">
            <div className="d-flex align-items-center justify-content-center justify-content-md-start">
              ...
              <h5 className="mb-0">HLS Video Platform</h5>
            </div>
            <p className="mb-0 mt-2 small">
              Nền tảng lưu trữ và phát video HLS
            </p>
          </Col>
          ...
          <Col md={4} className="text-center mb-3 mb-md-0">
            ...
            <p className="mt-2 mb-0 small text-secondary">
              &copy; {currentYear} HLS Video Platform
            </p>
          </Col>
          ...
          <Col md={4} className="text-center text-md-end">
            <p className="mb-0 small">
              <a 
                href="https://github.com/yourusername/hls-video-platform" 
                target="_blank" 
